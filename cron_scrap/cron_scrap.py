...
###########################################################################
#créations des listes qui permetront de récupérer les données( nb de fois nom journal j etc.)
...
try: 
    ...
    noms_journaux = ['Libération','Le Monde','Nord Presse','Science et Avenir','Closer','Gorafi','Le Point','Public','Figaro']
    ...
    while day!= hier:
        ...
        #récupération des titres via module scrap_titres.py (st) et mapping noms journaux et noms des fonctions
        #+ log d'erreurs
        ...
        if liste_titres:            
            ...
            #pour insertion BDD
            csv_path_name = "../bdd/titres_journaliers_to_bdd/titres_" + str(day) + ".csv"
            df.to_csv(index=False ,path_or_buf=csv_path_name,encoding = 'utf-8')
